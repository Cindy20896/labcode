...
if n_check == 2
save_filename = ['xymi_data43_' file_title_D '_' file_title_d '_step4.mat'];
save_filename_line = ['line_number43_' file_title_D '_' file_title_d '_step4.mat'];
save_path = ['light_data\' num2str(D) '_' num2str(d) '/'];
else
    save_filename = ['xymi_data43_water_' file_title_D '_' file_title_d '_step4.mat'];
save_filename_line = ['line_number43_water' file_title_D '_' file_title_d '_step4.mat'];
save_path = ['light_data\' num2str(D) '_' num2str(d) '/'];
end
