clearvars -except D d n_check n_A n_B n_C

[file_title_d,file_title_D] = title_fun(d,D);

if n_check == 2
load(['light_data\' num2str(D) '_' num2str(d) '\line_number_' file_title_D '_' file_title_d '.mat'])
else
    load(['light_data\' num2str(D) '_' num2str(d) '\line_number_water_' file_title_D '_' file_title_d '.mat'])
end
%間隔＝10^-3ｍｍ,線の数が5から4に変える場所を探す
...
if n_check == 2
save_filename = ['xymi_data54_' file_title_D '_' file_title_d '_step6.mat'];
save_filename_line = ['line_number54_' file_title_D '_' file_title_d '_step6.mat'];
save_path = ['light_data\' num2str(D) '_' num2str(d) '/'];
else
    save_filename = ['xymi_data54_water_' file_title_D '_' file_title_d '_step6.mat'];
save_filename_line = ['line_number54_water_' file_title_D '_' file_title_d '_step6.mat'];
save_path = ['light_data\' num2str(D) '_' num2str(d) '/'];
end
