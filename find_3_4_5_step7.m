...
if n_check == 2
save_filename = ['xymi_data54_' file_title_D '_' file_title_d '_step7.mat'];
save_filename_line = ['line_number54_' file_title_D '_' file_title_d '_step7.mat'];
save_path = ['light_data\' num2str(D) '_' num2str(d) '/'];
else
    save_filename = ['xymi_data54_water_' file_title_D '_' file_title_d '_step7.mat'];
save_filename_line = ['line_number54_water_' file_title_D '_' file_title_d '_step7.mat'];
save_path = ['light_data\' num2str(D) '_' num2str(d) '/'];
end
